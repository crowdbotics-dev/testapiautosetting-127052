...
## Project Structure
    ...
    ├── testapiautosetting_127052  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127052`
...
2. Clone this repo and `cd testapiautosetting_127052`
